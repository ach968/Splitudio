export default function PauseSVG({className} : {className?: string}) {
    return <svg className={className} fill="#FFFF" width="800px" height="800px" viewBox="0 0 32 32" enableBackground="new 0 0 32 32" version="1.1">
